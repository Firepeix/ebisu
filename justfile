...
_release-wewe:
  flutter build apk --dart-define=THEME=wewe --dart-define=TRAVEL_SHEET_ID=1OEA3xPP85ioFWrdR7RZD5gZlzKN267-fbrFUJQl5PWE --dart-define=USER=wewe --dart-define=FEATURES=expenses,travel --dart-define=EBISU_ENDPOINT=https://creative-lion-grown.ngrok-free.app --dart-define=AUTH_TOKEN=tewasdasd

_release-tutu:
  flutter build apk --dart-define=THEME=tutu --dart-define=TRAVEL_SHEET_ID=1OEA3xPP85ioFWrdR7RZD5gZlzKN267-fbrFUJQl5PWE --dart-define=USER=tutu --dart-define=FEATURES=expenses,books,travel --dart-define=EBISU_ENDPOINT=https://creative-lion-grown.ngrok-free.app --dart-define=AUTH_TOKEN=tewasdasd
