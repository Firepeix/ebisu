...
class TravelDayListItem extends StatelessWidget implements DecoratedTile {
  ...
  Color color() {
    ...
    return MoneyLabel(difference).getStrataColor();
  }
  ...
  Widget build(BuildContext context) {
    return Tile(
      ...
      subtitle: MoneyLabel(travelDay.budget),
      trailing: MoneyLabel(Money(spent.value,), color: Theme.of(context).colorScheme.primary,),
